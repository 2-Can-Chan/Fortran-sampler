! Original program provided by Dr. L. Konozsy, modified by J. Chan
...
! read parameters from file
      ...
      open (unit=1, file="Mod_parameters.par",status="old")
      read (1,*) rHeight
      read (1,*) rWidth
      read (1,*) rReynolds
      read (1,*) rPeclet
      ...
      read (1,*) iMaxIter
      read (1,*) rConvergence
      read (1,*) rAlphaP      !underrelaxation
      read (1,*) rAlphaU
      read (1,*) rAlphaV
      read (1,*) rAlphaC
      close(1)
...
! Details of d_(e,w,n,s), g_(e,w,n,s) can be seen in slide 14 of TDMA lab
!arguments
...
! JC comment - g is inviscid flux component, d is viscid flux component
      do i = 2 , iNxUNodes-1
         do J = 2 , iNyUNodes-1
           !!JC comment - for each location, find d_ & g_ to determine a_ of the loc
           !!JC comment - g is flux (or F in versteeg)
           !!JC comment - d is diffusion terms
...
! JC comment - slide 17 of TDMA lab
      rURes=0.
      do i = 2 , iNxUNodes - 1
         do j = 2 , iNyUNodes - 1
...
! JC comment
! Input: b is diagonal, a is left of diagonal and c is right of diagonal
!-----------------------------------------------------------------------
...
!-----------------------------------------------------------------------
         ...
         do m = 2 , n
            ...
            ! r is pressure (s_ij), d is a^s, e is a^n?
